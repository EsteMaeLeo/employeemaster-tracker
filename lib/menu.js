...
const { getRoles,
        setRole,
        deleteRoles } = require("./roles");
const { getDepartments,
        setDepartments,
        deleteDepartments} = require("./departments");
...
function deleteOptionDepartments() {
    getDepartments().
    then(departments => {
        ...
        inquirer.prompt(
            {
                ...
                const departmentId = departmentFind.id;
                 ...
                 deleteDepartments(departmentId).
                     then(departments => { 
                         console.log("Department deleted: " + departmentFind.name)
                         menuStart()
                     });
             })
             .catch(err => {
        ...
        inquirer.prompt(
            {
                ...
                message: "What is the employee's new role?",
                  ...
                  //find the register of the role
                const roleFind = roles.find(function (role) {
                    return role.Title === answers.roles_id;
                });
                
                const roletId = roleFind.Id;
